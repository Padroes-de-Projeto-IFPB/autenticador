...
import br.edu.ifpb.autenticador.autenticador.service.registry.BundledPermissionCache;
...
public class UserService {
    ...
    public void updateUserPermission(Long userId, String permissionName) {
        ...
        BundledPermissionCache cache = new BundledPermissionCache();
        Permissions permission = cache.get(permissionName);
